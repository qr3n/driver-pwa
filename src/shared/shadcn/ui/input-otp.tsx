...
>(({ index, className, ...props }, ref) => {
    ...
    return (
        <div
            ref={ref}
            className={cn(
                "relative flex transition-all h-14 w-14 items-center justify-center border-y border-r border-zinc-200 text-2xl shadow-sm rounded-2xl font-semibold dark:bg-zinc-700 dark:text-white dark:border-zinc-700",
